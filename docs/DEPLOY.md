...
> 📖 Это краткий инфраструктурный рунбук. Максимально подробный вариант
> «шаг за шагом с нуля» (подготовка сервера, firewall, первая рассылка,
> диагностика) — в [`../server/ADMIN.md`](../server/ADMIN.md).
